					...
					<div class="col-lg-4 col-md-6">
						<div class="desa-footer-brand">
							...
							<p class="desa-footer-desc small">
								<?php echo esc_html(get_bloginfo('description') ?: 'Website resmi desa untuk informasi pelayanan dan potensi desa.'); ?>
							</p>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-12">
						...
						<ul class="desa-footer-contact list-unstyled small">
							<li class="mb-2 d-flex align-items-start gap-2">
								...
								<span><?php echo esc_html(get_theme_mod('wsbase_desa_address', 'Alamat Kantor Desa')); ?></span>
							</li>
							<li class="mb-2 d-flex align-items-start gap-2">
								<span class="desa-footer-icon">📞</span>
								<span><?php echo esc_html(get_theme_mod('wsbase_desa_phone', '(021) 1234-5678')); ?></span>
							</li>
							<li class="mb-2 d-flex align-items-start gap-2">
								<span class="desa-footer-icon">✉️</span>
								<span><?php echo esc_html(get_theme_mod('wsbase_desa_email', get_bloginfo('admin_email'))); ?></span>
							</li>
						</ul>
